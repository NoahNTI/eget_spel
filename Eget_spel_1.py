...
def attack_potion(player, inventory):
    if inventory.attack_potion == 0:
        ...
        print(
            f'Du får 10 mera attack förmåga och har nu {player.damage} i skada')


'''monster list'''
monster_1 = monster('Matte 3C', 100, 20, 1)
monster_2 = monster('Matte 2C', 85, 10, 2)
monster_3 = monster('MATTE 4', 100, 25, 1)
monster_4 = monster('MATTE 5', 301, 30, 1)


def fight_scenario_1(player, monster):
    print(
        f'Medan du går stöter du på ett monster med namnet {monster.name} och har {monster.hp} i HP')
    ...
    while not monster.hp <= 0:
        ...
        act_1 = int(input(
            'Tryck (1) för att attackera eller tryck (2) för att inte göra något alls \n:  '))
        if act_1 == 1:
            ...
            if monster.hp <= 0:
                ...
                print(
                    f'Du går förbi liket av monstret och hittar {coin_loot} stycken coins')
                break
                ...
                if monster.hp-player.damage*2 <= 0:
                    ...
                    print(
                        f'Du attackerar monstret med en attack boost, dess nya HP är {monster.hp}')
            elif monster.hp > 0:
            ...
            if monster_attack == 1:
                ...
                if player.hp <= 0:
                    ...
                    print(
                        f'Medan du attackerar monstret slår det tillbaka och gör {monster.damage} i skada. Ditt nya HP är {player.hp}')
            ...
            if player.hp <= 0:
                ...
                print(
                    f'Medan du står och pillar dig i naveln så slår monstret dig. Ditt nya HP är {player.hp}')
...
def fight_scenario_2(player, monster):
    ...
    while not monster.hp <= 0:
        ...
        if act_1 == 1:
            ...
            print(
                f'Okej, du har {inventory.healing_potion} healingpotions och {inventory.attack_potion} attack potions kvar')
            prep_fight = int(input(
                'Tryck (1) för att använda healing potions, (2) för att använda en attack potions eller tryck(9) för att gå tillbaka till fighten\n: '))
            if prep_fight == 1:
...
(3) för att köpa armor, (8) för att kolla hur många Coins du har kvar eller (9) för att lämna shoppen: '''))
        ...
        if shop_act_1 == 9:
            ...
            shop_act_2 = int(input(
                'Du kan köpa 1 healing potion för 6 coins genom att trycka (1), eller tryck (2) för att avbryta köp\n:'))
            if shop_act_2 == 1:
                ...
                inventory.healing_potion = inventory.healing_potion + 1
                print(
                    f'Bra köp, du har nu {inventory.healing_potion} stycken healing potions')
            if shop_act_2 == 2:
                print('Okej')
        elif shop_act_1 == 2:
            shop_act_2 = int(input(
                'Du kan köpa 1 attack potion för 15 coins genom att trycka (1), eller tryck (2) för att avbryta köp\n:'))
            if shop_act_2 == 1:
                if inventory.coin-15 < 0:
                    ...
                    inventory.attack_potion = inventory.attack_potion + 1
                    print(
                        f'Bra köp, du har nu {inventory.attack_potion} stycken attack potions')
            if shop_act_2 == 2:
                print('Okej')
        elif shop_act_1 == 3:
...
fight_scenario_1(player, monster_1)
...
fight_scenario_2(player, monster_2)
...
fight_scenario_2(player, monster_3)

wait()

fight_scenario_2(player, monster_4)
